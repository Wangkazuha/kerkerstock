...
import ApiResourcesCard from './components/ApiResourcesCard'; // Updated import
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-4">
              <div className="lg:col-span-2 space-y-8">
                ...
                {/* --- CHANGED: MOPS Financial Report Link (Dynamic) --- */}
                <ApiResourcesCard
                  ...
                  resources={[
                    {
                      ...
                      // Using year=113 (2024) as a safe default for recent data, ensuring user sees data instead of blank future dates
